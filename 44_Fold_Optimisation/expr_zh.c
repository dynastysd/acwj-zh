...
// 解析零个或多个逗号分隔的表达式，
// 返回由 A_GLUE 节点组成的 AST，左子
// 是先前表达式的子树（或 NULL），右子是
// 下一个表达式。每个 A_GLUE 节点的 size 字段
// 将设置为此时树中的表达式数量。如果没有
// 解析表达式，则返回 NULL
