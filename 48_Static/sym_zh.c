...
// 设置节点的：
// + type: char、int 等
// + ctype: struct/union 的复合类型指针
// + structural type: var、function、array 等
// + size: 元素数量，或函数的 endlabel：结束标签
// + posn: 局部符号的位置信息
// 返回指向新节点的指针
