...
// 将所有寄存器设置为可用。但如果 reg 为正，则不释放该寄存器。
...
// 给定带有参数值的寄存器，
// 将此参数复制到为将来函数调用
// 准备的第 argposn'th 参数中。注意 argposn
// 是 1, 2, 3, 4, ...，永不为零。
