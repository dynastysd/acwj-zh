...
int cgloadglob(int id) {
  ...
  switch (Symtable[id].type) {
    ...
    case P_LONGPTR:
      ...
      break;
    default:
      fatald("cgloadglob 中的错误类型：", Symtable[id].type);
  }
  return (r);
}
...
int cgstorglob(int r, int id) {
  ...
  switch (Symtable[id].type) {
    ...
    case P_LONGPTR:
      ...
      break;
    default:
      fatald("cgstorglob 中的错误类型：", Symtable[id].type);
  }
  return (r);
}
...
void cgglobsym(int id) {
  ...
  switch (typesize) {
    ...
    case 4:
      ...
      break;
    default:
      fatald("cgglobsym 中未知类型大小：", typesize);
  }
}
