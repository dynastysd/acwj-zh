...
static struct symtable *composite_declaration(int type) {
  ...
  // 查看是否有 following struct/union 名称
  ...
  // 在组合类型中设置每个后续成员的位置
  // union 很容易。对于 struct，对齐成员并找到下一个空闲字节
