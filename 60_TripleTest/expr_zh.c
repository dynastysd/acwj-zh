...
struct ASTnode *binexpr(int ptp) {
  ...
  while ((op_precedence(tokentype) > ptp) ||
    ...
    default:
      ...
      // rvalue。如果它们是 lvalue 树，则将两者都转换为 rvalue
      left->rvalue = 1;
      right->rvalue = 1;
