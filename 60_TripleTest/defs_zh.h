...
// 词法标记结构
struct token {
  int token;			// 词法标记类型，来自上面的枚举列表
  char *tokstr;			// 词法标记的字符串版本
...
#define a_intvalue a_size	// 对于 A_INTLIT，整数值
  int a_size;			// 对于 A_SCALE，按此大小缩放
  int linenum;			// 此节点来源的行号
};
